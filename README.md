...
## Setup
Setting up the MusicBot is relatively painless - just follow one of the [guides](https://discord.gg/JC7bWUg). After that, configure the bot to ensure its connection to Discord.
...
There are many commands that can be used with the bot. Most notably, the `play <url>` command (preceded by your command prefix) will download, process, and play a song from YouTube or a similar site. A full list of commands is available [here]( "Commands").

### Further reading

* [Support Discord server](https://discord.gg/JC7bWUg)
